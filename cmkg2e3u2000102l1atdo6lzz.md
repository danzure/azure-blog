...
The new year for a lot of us marks the start of something new, something we want to improve on or achieve in the year ahead, whether that's the diet you start every year or something else entirely and in keeping with the spirit of starting that self-improvement journey for this month's (long overdue) blog entry, I’ve decided to take a break from my [A-Z of Azure series](https://a-z-ure.blog/series/a-z-of-azure). Instead. I want to cover the ‘*How to..*’ of Microsoft Certifications: what are they and how do you get certified.

What inspired this? Well, over the past month (or two), I’ve slowly been working towards expanding my own certification collection. With the New Year here, many of you will be wanting that new job or perhaps going for a promotion, so I figured, what better time to put something like this together? While Microsoft themselves have an assortment of resources and information regarding ‘Getting Certified’, I wanted to try to break it down and simplify the information from my experience. This guide is for those of you who are perhaps new to the certification process, or perhaps those wanting to break into their first cloud-based or IT engineering role.
